$(document).ready(function () {
    ...
    $('#teamRssFeed').FeedEk({
        FeedUrl: 'http://www.bbc.com/sport/football/teams/west-bromwich-albion/rss.xml',
    });
    $("#latestNews").html("Latest Team News");

    $('#teamNews').text('Current West Brom Form');
    $("#myTable").dataTable({
        'iDisplayLength': 5,
        'bJQueryUI': true,
        "aaData": [],
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/PremierLeague/WestBrom/pulis.jpg");
    $("#managersName").html("Tony Pulis");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/74/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/74/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function renderTeamLeagueStandingData(result) {
    ...
    $.each(result.standing, function (index) {
        var name = "West Bromwich Albion FC";
    ...
    $('#teamStanding_tbl tr td').each(function () {
        if ($(this).text() === 'West Bromwich Albion FC')
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/fletcher.jpg");
            break;
        case 'Matt Phillips': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/phillips.jpg");
            break;
        case 'Ben Foster': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/foster.jpg");
            break;
        case 'Boaz Myhill': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/myhill.jpg");
            break;
        case 'Jack Rose': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/rose.jpg");
            break;
        case 'Jonny Evans': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/evans.jpg");
            break;
        case 'Jonas Olsson': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/olsson.jpg");
            break;
        case 'Gareth McAuley': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/mcauley.jpg");
            break;
        case 'Craig Dawson': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/dawson.jpg");
            break;
        case 'Claudio Yacob': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/yacob.jpg");
            break;
        case 'James Morrison': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/morrison.jpg");
            break;
        case 'Craig Gardner': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/gardner.jpg");
            break;
        case 'Darren Fletcher': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/fletcher.jpg");
            break;
        case 'Chris Brunt': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/brunt.jpg");
            break;
        case 'James McClean': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/mcclean.jpg");
            break;
        case 'Callum McManaman': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/mcmanaman.jpg");
            break;
        case 'Jonathan Leko': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/leko.jpg");
            break;
        case 'José Salomón Rondón': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/rondon.jpg");
            break;
        case 'Saido Berahino': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/berahino.jpg");
            break;
        case 'Allan Nyom': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/nyom.jpg");
            break;
        case 'Nacer Chadli': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/chadli.jpg");
            break;
        case 'Brendan Galloway': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/galloway.jpg");
            break;
        case 'Hal Robson-Kanu': $("#playerPicture").attr("src", "../../Players/PremierLeague/WestBrom/kanu.jpg");
            break;
