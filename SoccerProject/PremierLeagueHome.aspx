...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="teamsID" class="row">
        ...
        <div class="col-md-3">
            <a href="Teams/Premier_League_Teams/CrystalPalace.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/Premier_League_Teams/Watford.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/Premier_League_Teams/WestBrom.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/Premier_League_Teams/WestHam.aspx" target="_blank" >
