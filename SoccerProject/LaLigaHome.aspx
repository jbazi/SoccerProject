...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="teamsID" class="row">
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/Alaves.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/AtleticoBilbao.aspx" target="_blank"  >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/AtleticoDeMadrid.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/Barcelona.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/CeltaVigo.aspx" target="_blank"  >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/DeportivoLaCoruna.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/SdEibar.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/Espanyol.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/Granada.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/LasPalmas.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/Malaga.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/RealBetis.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/RealMadrid.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/RealSociedad.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/Sevilla.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/SportingGijon.aspx" target="_blank"  >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/Valencia.aspx" target="_blank" >
        ...
        <div class="col-md-3">
            <a href="Teams/La_Liga_Teams/Villarreal.aspx" target="_blank" >
