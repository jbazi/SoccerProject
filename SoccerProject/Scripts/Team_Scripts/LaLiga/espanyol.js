$(document).ready(function () {
    ...
    $('#teamRssFeed').FeedEk({
        FeedUrl: 'http://www.bbc.com/sport/football/teams/espanyol/rss.xml',
    });
    $("#latestNews").html("Latest Team News");

    $('#teamNews').text('Deportivo La Coruna Form');
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LaLiga/Espanyol/flores.jpg");
    $("#managersName").html("Quique Sánchez Flores");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/80/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/80/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/gerard.jpg");
            break;
        case 'Mickael Ciani': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/ciani.jpg");
            break;
        case 'David López': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/david.jpg");
            break;
        case 'Roberto': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/roberto.jpg");
            break;
        case 'Víctor Álvarez': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/victor.jpg");
            break;
        case 'Javi López': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/javi.jpg");
            break;
        case 'Anaitz Arbilla': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/anaitz.jpg");
            break;
        case 'Víctor Sánchez': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/victorSanchez.jpg");
            break;
        case 'Salva Sevilla': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/salva.jpg");
            break;
        case 'Felipe Caicedo': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/caicedo.jpg");
            break;
        case 'Papakouli Diop': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/diop.jpg");
            break;
        case 'Hernán Pérez': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/perez.jpg");
            break;
        case 'Fernando Navarro': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/navarro.jpg");
            break;
        case 'Gerard Moreno': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/gerard.jpg");
            break;
        case 'José Antonio Reyes': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/reyes.jpg");
            break;
        case 'Javi Fuego': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/javiFuego.jpg");
            break;
        case 'Pablo Piatti': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/piatti.jpg");
            break;
        case 'Leo Baptistão': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/leo.jpg");
            break;
        case 'Rubén Duarte': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/ruben.jpg");
            break;
        case 'Óscar Duarte': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/oscar.jpg");
            break;
        case 'Martín Demichelis': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/demichelis.jpg");
            break;
        case 'Álex Fernández': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/alex.jpg");
            break;
        case 'José Manuel Jurado': $("#playerPicture").attr("src", "../../Players/LaLiga/Espanyol/jurado.jpg");
            break;
