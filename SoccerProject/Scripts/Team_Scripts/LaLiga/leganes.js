$(document).ready(function () {
    ...
    $('#teamRssFeed').FeedEk({
        FeedUrl: 'http://www.bbc.com/sport/football/teams/leganes/rss.xml',
    });
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LaLiga/Leganes/garitano.jpg");
    $("#managersName").html("Asier Garitano");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/745/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/745/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/ronaldo.jpg");
            break;
        case 'Álvaro Morata': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/morata.jpg");
            break;
        case 'Mateo Kovacic': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/kovacic.jpg");
            break;
        case 'Casemiro': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/casemiro.jpg");
            break;
        case 'Kiko Casilla': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/casilla.jpg");
            break;
        case 'Lucas Vázquez': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/cech.jpg");
            break;
        case 'Keylor Navas': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/navas.jpg");
            break;
        case 'Sergio Ramos': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/ramos.jpg");
            break;
        case 'Raphaël Varane': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/varane.jpg");
            break;
        case 'Pepe': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/pepe.jpg");
            break;
        case 'Nacho Fernández': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/nacho.jpg");
            break;
        case 'Fábio Coentrão': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/coentrao.jpg");
            break;
        case 'Daniel Carvajal': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/carvajal.jpg");
            break;
        case 'Luka Modric': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/modric.jpg");
            break;
        case 'Toni Kroos': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/kroos.jpg");
            break;
        case 'James Rodríguez': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/james.jpg");
            break;
        case 'Isco': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/isco.jpg");
            break;
        case 'Cristiano Ronaldo': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/ronaldo.jpg");
            break;
        case 'Gareth Bale': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/bale.jpg");
            break;
        case 'Karim Benzema': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/benzema.jpg");
            break;
        case 'Lucas Silva': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/silva.jpg");
            break;
        case 'Marcelo': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/marcelo.jpg");
            break;
        case 'Marco Asensio': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/asensio.jpg");
            break;
        case 'Rubén Yáñez': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/yanez.jpg");
            break;
        case 'Mariano Díaz': $("#playerPicture").attr("src", "../../Players/LaLiga/Leganes/diaz.jpg");
            break;
