$(document).ready(function () {
    ...
    $('#teamRssFeed').FeedEk({
        FeedUrl: 'http://www.bbc.com/sport/football/teams/eibar/rss.xml',
    });
    $("#latestNews").html("Latest Team News");

    $('#teamNews').text('SD Eibar Form');
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LaLiga/Eibar/mendilibar.jpg");
    $("#managersName").html("Jose LuisMendilibar");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/278/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/278/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/leon.jpg");
            break;
        case 'Antonio Luna': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/antonio.jpg");
            break;
        case 'Takashi Inui': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/inui.jpg");
            break;
        case 'Mauro dos Santos': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/mauro.jpg");
            break;
        case 'Fran Rico': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/fran.jpg");
            break;
        case 'Dani García': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/dani.jpg");
            break;
        case 'Ander Capa': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/capa.jpg");
            break;
        case 'Pedro León': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/leon.jpg");
            break;
        case 'Adrián González': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/adrian.jpg");
            break;
        case 'Yoel Rodríguez': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/yoel.jpg");
            break;
        case 'Bebé': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/bebe.jpg");
            break;
        case 'Iván Ramis': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/ramis.jpg");
            break;
        case 'Alejandro Gálvez': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/galvez.jpg");
            break;
        case 'Asier Riesgo': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/riesgo.jpg");
            break;
        case 'David Juncà': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/david.jpg");
            break;
        case 'Gonzalo Escalante': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/escalante.jpg");
            break;
        case 'Sergi Enrich': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/sergi.jpg");
            break;
        case 'Jota': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/jota.jpg");
            break;
        case 'Florian Lejeune': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/florian.jpg");
            break;
        case 'Cristian Rivera': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/cristian.jpg");
            break;
        case 'Rubén Peña': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/ruben.jpg");
            break;
        case 'Kike': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/kike.jpg");
            break;
        case 'Marco Asensio': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/asensio.jpg");
            break;
        case 'Rubén Yáñez': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/yanez.jpg");
            break;
        case 'Mariano Díaz': $("#playerPicture").attr("src", "../../Players/LaLiga/Eibar/diaz.jpg");
            break;
