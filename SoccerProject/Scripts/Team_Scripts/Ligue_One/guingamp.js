$(document).ready(function () {
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LigueOne/Guingamp/antoine.jpg");
    $("#managersName").html("KOMBOUARE Antoine");
...
function renderLoadedPlayers(userSelection) {
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/538/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/538/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/marcus.jpg");
            break;
        case 'Jimmy Briand': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/jimmy.jpg");
            break;
        case 'Étienne Didot': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/didot.jpg");
            break;
        case 'Lucas Deaux': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/lucas.jpg");
            break;
        case 'Benjamin Angoua': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/brou.jpg");
            break;
        case 'Christophe Kerbrat': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/kerbrat.jpg");
            break;
        case 'Jérémy Sorbon': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/jeremy.jpg");
            break;
        case 'Reynald Lemaître': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/reynald.jpg");
            break;
        case 'Dorian Lévêque': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/dorian.jpg");
            break;
        case 'Baissama Sankoh': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/sankoh.jpg");
            break;
        case 'Mustapha Diallo': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/diallo.jpg");
            break;
        case 'Yannis Salibur': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/yannis.jpg");
            break;
        case 'Thibault Giresse': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/thibault.jpg");
            break;
        case 'Nicolas Benezet': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/nicolas.jpg");
            break;
        case 'Sloan Privat': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/sloan.jpg");
            break;
        case 'Romain Salin': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/salin.jpg");
            break;
        case 'Marçal': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/marcal.jpg");
            break;
        case 'Jonathan Martins Pereira': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/jonathan.jpg");
            break;
        case 'Alexandre Mendy': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/mendy.jpg");
            break;
        case 'Théo Guivarch': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/theo.jpg");
            break;
        case 'Ludovic Blas': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/blas.jpg");
            break;
        case 'Nill de Pauw': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/nill.jpg");
            break;
        case 'Marcus Coco': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/marcus.jpg");
            break;
        case 'Jordan Ikoko': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/ikoko.jpg");
            break;
        case 'Karl-Johan Johnsson': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/karl.jpg");
            break;
        case 'Jérémy Livolant': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/jeremy.jpg");
            break;
        case 'Sullivan Martinet': $("#playerPicture").attr("src", "../../Players/LigueOne/Guingamp/martinet.jpg");
            break;
