$(document).ready(function () {
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LigueOne/Lorient/casoni.jpg");
    $("#managersName").html("Bernard Casoni");
...
function renderLoadedPlayers(userSelection) {
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/525/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/525/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/benjamin.jpg");
            break;
        case 'Benjamin Moukandjo': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/benjamin.jpg");
            break;
        case 'Sylvain Marveaux': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/sylvain.jpg");
            break;
        case 'Lindsay Rose': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/rose.jpg");
            break;
        case 'Arnold Mvuemba': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/arnold.jpg");
            break;
        case 'Steven Moreira': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/moreira.jpg");
            break;
        case 'Benjamin Lecomte': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/benjamin.jpg");
            break;
        case 'Wesley Lautoa': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/wesley.jpg");
            break;
        case 'François Bellugou': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/bellugou.jpg");
            break;
        case 'Vincent Le Goff': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/goff.jpg");
            break;
        case 'Walid Mesloub': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/walid.jpg");
            break;
        case 'Maxime Barthelmé': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/maxime.jpg");
            break;
        case 'Benjamin Jeannot': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/benjamin.jpg");
            break;
        case 'Romain Philippoteaux': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/romain.jpg");
            break;
        case 'Cafú': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/cafu.jpg");
            break;
        case 'Jimmy Cabot': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/cabot.jpg");
            break;
        case 'Zargo Touré': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/toure.jpg");
            break;
        case 'Pape Paye': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/pape.jpg");
            break;
        case 'Moryké Fofana': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/fofana.jpg");
            break;
        case 'Waris Majeed': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/waris.jpg");
            break;
        case 'Paul Delecroix': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/paul.jpg");
            break;
        case 'Anthony Lamonge': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/lamonge.jpg");
            break;
        case 'Bradley Mazikou': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/bradley.jpg");
            break;
        case 'Faïz Selemani': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/faiz.jpg");
            break;
        case 'Issam Ben Khemis': $("#playerPicture").attr("src", "../../Players/LigueOne/Lorient/issam.jpg");
            break;
