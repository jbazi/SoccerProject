$(document).ready(function () {
    ...
    $('#teamRssFeed').FeedEk({
        FeedUrl: 'http://www.bbc.com/sport/football/teams/sporting-gijon/rss.xml',
    });
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LaLiga/SportingGijon/abelardo.jpg");
    $("#managersName").html("Fernández Abelardo");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/96/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/96/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/cuellar.jpg");
            break;
        case 'Diego Mariño': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/marino.jpg");
            break;
        case 'Moi Gómez': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/moi.jpg");
            break;
        case 'Jean-Sylvain Babin': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/babin.jpg");
            break;
        case 'Roberto Canella': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/canella.jpg");
            break;
        case 'Lillo Castellano': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/lillo.jpg");
            break;
        case 'Douglas': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/douglas.jpg");
            break;
        case 'Víctor Rodríguez': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/victor.jpg");
            break;
        case 'Burgui': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/burgui.jpg");
            break;
        case 'Iván Cuéllar': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/cuellar.jpg");
            break;
        case 'Jorge Meré': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/mere.jpg");
            break;
        case 'Alberto Lora': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/lora.jpg");
            break;
        case 'Nacho Cases': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/cases.jpg");
            break;
        case 'Rachid Aït-Atmane': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/rachid.jpg");
            break;
        case 'Isma López': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/isma.jpg");
            break;
        case 'Pablo Pérez': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/pablo.jpg");
            break;
        case 'Carlos Castro': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/castro.jpg");
            break;
        case 'Xavi Torres': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/xavi.jpg");
            break;
        case 'Dani Ndi': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/ndi.jpg");
            break;
        case 'Óscar Whalley': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/oscar.jpg");
            break;
        case 'Fernando Amorebieta': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/amorebieta.jpg");
            break;
        case 'Akram Afif': $("#playerPicture").attr("src", "../../Players/LaLiga/SportingGijon/afif.jpg");
            break;
