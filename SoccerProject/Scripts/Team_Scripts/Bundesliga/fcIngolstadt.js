$(document).ready(function () {
    ...
    $('#teamNews').text('FC Ingolstadt 04 Form');
    $("#myTable").dataTable({
        'iDisplayLength': 5,
        'bJQueryUI': true,
        "aaData": [],
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/henke.jpg");
    $("#managersName").html("<strong>	Michael Henke</strong>");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/31/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/31/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/lukas.jpg");
            break;
        case 'Anthony Jung': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/jung.jpg");
            break;
        case 'Robert Leipertz': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/robert.jpg");
            break;
        case 'Marcel Tisserand': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/marcel.jpg");
            break;
        case 'Sonny Kittel': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/sonny.jpg");
            break;
        case 'Maurice Multhaup': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/maurice.jpg");
            break;
        case 'Örjan Nyland': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/nyland.jpg");
            break;
        case 'Christian Ortag': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/ortag.jpg");
            break;
        case 'Romain Brégerie': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/romain.jpg");
            break;
        case 'Marvin Matip': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/matip.jpg");
            break;
        case 'Markus Suttner': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/markus.jpg");
            break;
        case 'Tobias Levels': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/tobias.jpg");
            break;
        case 'Roger': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/roger.jpg");
            break;
        case 'Max Christiansen': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/max.jpg");
            break;
        case 'Almog Cohen': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/almog.jpg");
            break;
        case 'Pascal Groß': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/pascal.jpg");
            break;
        case 'Alfredo Morales': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/morales.jpg");
            break;
        case 'Mathew Leckie': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/mathew.jpg");
            break;
        case 'Stefan Lex': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/stefan.jpg");
            break;
        case 'Lukas Hinterseer': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/lukas.jpg");
            break;
        case 'Moritz Hartmann': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/moritz.jpg");
            break;
        case 'Hauke Wahl': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/wahl.jpg");
            break;
        case 'Darío Lezcano': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/dario.jpg");
            break;
        case 'Nico Rinderknecht': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/nico.jpg");
            break;
        case 'Martin Hansen': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/hansen.jpg");
            break;
        case 'Fabijan Buntic': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/buntic.jpg");
            break;
        case 'Florent Hadergjonaj': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Ingolstadt/florent.jpg");
            break;
