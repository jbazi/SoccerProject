$(document).ready(function () {
    ...
    $('#teamRssFeed').FeedEk({
        FeedUrl: 'http://www.bbc.com/sport/football/teams/tottenham-hotspur/rss.xml',
    });
    $("#latestNews").html("Latest Team News");

    $('#teamNews').text('Current Tottenham Form');
    $("#myTable").dataTable({
        'iDisplayLength': 5,
        'bJQueryUI': true,
        "aaData": [],
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/PremierLeague/Tottenham/m_pochettino.jpg");
    $("#managersName").html("Mauricio Pochettino");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/73/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/73/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function renderTeamLeagueStandingData(result) {
    ...
    $('#teamStanding_tbl tr td').each(function () {
        if ($(this).text() === 'Tottenham Hotspur FC')
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/h_kane.jpg");
            break;
        case 'Moussa Sissoko': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/m_sissoko2.jpg");
            break;
        case "Georges-Kevin N'Koudou": $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/gk_nkoudou2.jpg");
            break;
        case 'Pau López': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/lopez.jpg");
            break;
        case 'Hugo Lloris': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/h_lloris.jpg");
            break;
        case 'Michel Vorm': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/m_vorm.jpg");
            break;
        case 'Toby Alderweireld': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/t_alderweireld.jpg");
            break;
        case 'Jan Vertonghen': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/j_vertonghen.jpg");
            break;
        case 'Kevin Wimmer': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/k_wimmer.jpg");
            break;
        case 'Danny Rose': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/d_rose.jpg");
            break;
        case 'Ben Davies': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/b_davies.jpg");
            break;
        case 'Kyle Walker': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/k_walker.jpg");
            break;
        case 'Kieran Trippier': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/k_trippier.jpg");
            break;
        case 'Eric Dier': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/e_dier.jpg");
            break;
        case 'Victor Wanyama': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/v_wanyama.jpg");
            break;
        case 'Dele Alli': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/d_alli.jpg");
            break;
        case 'Mousa Dembélé': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/m_dembele.jpg");
            break;
        case 'Tom Carroll': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/t_carrol.jpg");
            break;
        case 'Christian Eriksen': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/c_eriksen.jpg");
            break;
        case 'Josh Onomah': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/j_onomah.jpg");
            break;
        case 'Érik Lamela': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/e_lamela.jpg");
            break;
        case 'Heung-Min Son': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/hm_son2.jpg");
            break;
        case 'Harry Kane': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/h_kane.jpg");
            break;
        case 'Vincent Janssen': $("#playerPicture").attr("src", "../../Players/PremierLeague/Tottenham/v_janssen.jpg");
            break;
