$(document).ready(function () {
    ...
    $('#teamRssFeed').FeedEk({
        FeedUrl: 'http://www.bbc.com/sport/football/teams/barcelona/rss.xml',
    });
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LaLiga/Barcelona/enrique.jpg");
    $("#managersName").html("Luis Enrique");
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/messi.jpg");
            break;
        case 'Lucas Digne': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/digne.jpg");
            break;
        case 'Samuel Umtiti': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/umtiti.jpg");
            break;
        case 'Jasper Cillessen': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/cillessen.jpg");
            break;
        case 'Marc-André ter Stegen': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/stegen.jpg");
            break;
        case 'Jordi Masip': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/masip.jpg");
            break;
        case 'Gerard Piqué': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/pique.jpg");
            break;
        case 'Javier Mascherano': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/mascherano.jpg");
            break;
        case 'Jérémy Mathieu': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/mathieu.jpg");
            break;
        case 'Jordi Alba': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/alba.jpg");
            break;
        case 'Sergio Busquets': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/sergio.jpg");
            break;
        case 'Andrés Iniesta': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/iniesta.jpg");
            break;
        case 'Ivan Rakitic': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/rakitic.jpg");
            break;
        case 'Sergi Roberto': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/reoberto.jpg");
            break;
        case 'Neymar': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/neymar.jpg");
            break;
        case 'Lionel Messi': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/messi.jpg");
            break;
        case 'Luis Suárez': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/suarez.jpg");
            break;
        case 'Munir El Haddadi': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/munir.jpg");
            break;
        case 'Aleix Vidal': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/vidal.jpg");
            break;
        case 'André Gomes': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/gomes.jpg");
            break;
        case 'Arda Turan': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/arda.jpg");
            break;
        case 'Denis Suárez': $("#playerPicture").attr("src", "../../Players/LaLiga/Barcelona/denis.jpg");
            break;
