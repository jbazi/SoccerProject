$(document).ready(function () {
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/Players/PremierLeague/HullCity/howe.jpg");
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/wilshere.jpg");
            break;
        case 'Steve Harper': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/harper.jpg");
            break;
        case 'Harry Maguire': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/maguire.jpg");
            break;
        case 'Robbie Brady': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/brady.jpg");
            break;
        case "Allan McGregor": $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/mcgregor.jpg");
            break;
        case 'Eldin Jakupovic': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/Jakupovic.jpg");
            break;
        case 'Michael Dawson': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/dawson.jpg");
            break;
        case 'Curtis Davies': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/davies.jpg");
            break;
        case 'Alex Bruce': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/bruce.jpg");
            break;
        case 'Andrew Robertson': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/robertson.jpg");
            break;
        case 'Tom Huddlestone': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/huddlestone.jpg");
            break;
        case 'David Meyler': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/meyler.jpg");
            break;
        case 'Jake Livermore': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/livermore.jpg");
            break;
        case 'Ahmed Elmohamady': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/ahmed.jpg");
            break;
        case 'Robert Snodgrass': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/snodgrass.jpg");
            break;
        case 'Abel Hernández': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/hernandez.jpg");
            break;
        case 'Yannick Sagbo': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/arter.jpg");
            break;
        case 'Emerson Hyndman': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/hyndman.jpg");
            break;
        case 'Max Gradel': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/gradel.jpg");
            break;
        case 'Junior Stanislas': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/stanislas.jpg");
            break;
        case 'Marc Pugh': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/pugh.jpg");
            break;
        case 'Ryan Fraser': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/fraser.jpg");
            break;
        case 'Joshua King': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/king.jpg");
            break;
        case 'Benik Afobe': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/afobe.jpg");
            break;
        case 'Callum Wilson': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/wilson.jpg");
            break;
        case 'Lewis Grabban': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/grabban.jpg");
            break;
        case 'Marc Wilson': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/marcWilson.jpg");
            break;
        case 'Jack Wilshere': $("#playerPicture").attr("src", "../../Players/Players/PremierLeague/HullCity/wilshere.jpg");
            break;
