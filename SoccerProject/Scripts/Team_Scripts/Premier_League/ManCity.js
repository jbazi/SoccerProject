$(document).ready(function () {
    ...
    $('#teamRssFeed').FeedEk({
        FeedUrl: 'http://newsrss.bbc.co.uk/rss/sportonline_uk_edition/football/teams/m/man_city/rss.xml',
    });
    $('#latestNews').text('Latest Team News');

    $('#teamNews').text('Current Man City Form');
    $("#myTable").dataTable({
        'iDisplayLength': 5,
        'bJQueryUI': true,
        "aaData": [],
    ...
    var userSelection = "Sergio Agüero";
    renderLoadedPlayers(userSelection);
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/PremierLeague/ManCity/guardiola.jpg");
    $("#managersName").html("Pep Guardiola");
...
function renderTeamLeagueStandingData(result) {
    ...
    $('#teamStanding_tbl tr td').each(function () {
        if ($(this).text() === 'Manchester City FC')
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/aguero.jpg");
            break;
        case 'John Stones': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/stones.jpg");
            break;
        case 'Fernando': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/fernando.jpg");
            break;
        case 'Nolito': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/nolito.jpg");
            break;
        case 'Claudio Bravo': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/cBravo.jpg");
            break;
        case 'Ilkay Gündogan': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/gundogan.jpg");
            break;
        case 'Willy Caballero': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/caballero.jpg");
            break;
        case 'Nicolás Otamendi': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/otamendi.jpg");
            break;
        case 'Vincent Kompany': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/kompany.jpg");
            break;
        case 'Gaël Clichy': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/clichy.jpg");
            break;
        case 'Pablo Zabaleta': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/zabaleta.jpg");
            break;
        case 'Bacary Sagna': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/sagna.jpg");
            break;
        case 'Fernandinho': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/fernandinho.jpg");
            break;
        case 'Yaya Touré': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/toure.jpg");
            break;
        case 'Fabian Delph': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/delph.jpg");
            break;
        case 'Kevin De Bruyne': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/bryune.jpg");
            break;
        case 'David Silva': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/silva.jpg");
            break;
        case 'Jesús Navas': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/navas.jpg");
            break;
        case 'Raheem Sterling': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/sterling.jpg");
            break;
        case 'Sergio Agüero': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/aguero.jpg");
            break;
        case 'Kelechi Iheanacho': $("#playerPicture").attr("src", "../../Players/PremierLeague/ManCity/iheanacho.jpg");
            break;
