$(document).ready(function () {
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LigueOne/Etienne/galtier.jpg");
    $("#managersName").html("Christophe Galtier");
...
function renderLoadedPlayers(userSelection) {
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/527/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/527/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/beric.jpg");
            break;
        case 'Jordan Veretout': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/jordan.jpg");
            break;
        case 'Bryan Dabo': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/dabo.jpg");
            break;
        case 'Henri Saivet': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/henri.jpg");
            break;
        case 'Nolan Roux': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/nolan.jpg");
            break;
        case 'Stéphane Ruffier': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/ruffier.jpg");
            break;
        case 'Jessy Moulin': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/jessy.jpg");
            break;
        case 'Loïc Perrin': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/loic.jpg");
            break;
        case 'Florentin Pogba': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/pogba.jpg");
            break;
        case 'Kévin Théophile-Catherine': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/kevin.jpg");
            break;
        case 'Fabien Lemoine': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/fabien.jpg");
            break;
        case 'Jérémy Clément': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/clement.jpg");
            break;
        case 'Benjamin Corgnet': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/corgnet.jpg");
            break;
        case 'Romain Hamouma': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/romain.jpg");
            break;
        case 'Kévin Monnet-Paquet': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/monnet.jpg");
            break;
        case "Cheikh M'Bengue": $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/cheikh.jpg");
            break;
        case 'Vincent Pajot': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/pajot.jpg");
            break;
        case 'Anthony Maisonnial': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/anthony.jpg");
            break;
        case 'Pierre-Yves Polomat': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/yves.jpg");
            break;
        case 'Kévin Malcuit': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/kevin.jpg");
            break;
        case 'Robert Beric': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/beric.jpg");
            break;
        case 'Ole Selnaes': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/ole.jpg");
            break;
        case 'Oussama Tannane': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/tannane.jpg");
            break;
        case "Alexander Söderlund": $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/alexander.jpg");
            break;
        case 'Léo Lacroix': $("#playerPicture").attr("src", "../../Players/LigueOne/Etienne/leo.jpg");
            break;
