$(document).ready(function () {
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LigueOne/Nantes/sergio.jpg");
    $("#managersName").html("Sergio Conceicao");
...
function renderLoadedPlayers(userSelection) {
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/543/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/543/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/mariusz.jpg");
            break;
        case 'Rémy Riou': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/remy.jpg");
            break;
        case 'Maxime Dupé': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/dupe.jpg");
            break;
        case 'Oswaldo Vizcarrondo': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/oswaldo.jpg");
            break;
        case 'Koffi Djidji': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/koffi.jpg");
            break;
        case 'Léo Dubois': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/leo.jpg");
            break;
        case 'Abdoulaye Touré': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/toure.jpg");
            break;
        case 'Valentin Rongier': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/valentin.jpg");
            break;
        case 'Yacine Bammou': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/yacine.jpg");
            break;
        case 'Emiliano Sala': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/sala.jpg");
            break;
        case 'Adrien Thomasson': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/adrien.jpg");
            break;
        case 'Guillaume Gillet': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/gillet.jpg");
            break;
        case 'Fernando Aristeguieta': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/fernando.jpg");
            break;
        case 'Wilfried Moimbé': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/wilfred.jpg");
            break;
        case 'Lucas Lima': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/lima.jpg");
            break;
        case 'Diego Carlos': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/diego.jpg");
            break;
        case 'Alexis Alégué': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/alexis.jpg");
            break;
        case 'Jules Iloki': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/jules.jpg");
            break;
        case 'Anthony Walongwa': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/anthony.jpg");
            break;
        case 'Alexandre Olliero': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/alexandre.jpg");
            break;
        case 'Quentin Braat': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/braat.jpg");
            break;
        case 'Enock Kwateng': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/enock.jpg");
            break;
        case 'Amine Harit': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/harit.jpg");
            break;
        case "Alexander Kacaniklic": $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/kacaniklic.jpg");
            break;
        case 'Nicolaj Thomsen': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/nicolaj.jpg");
            break;
        case 'Mariusz Stepinski': $("#playerPicture").attr("src", "../../Players/LigueOne/Nantes/mariusz.jpg");
            break;
