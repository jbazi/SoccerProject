$(document).ready(function () {
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LigueOne/Bordeaux/jocelyn.jpg");
    $("#managersName").html("GOURVENNEC Jocelyn");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/526/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/526/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function renderTeamLeagueStandingData(result) {
    ...
    $.each(result.standing, function (index) {
        var name = "FC Girondins de Bordeaux";
    ...
    $('#teamStanding_tbl tr td').each(function () {
        if ($(this).text() === 'FC Girondins de Bordeaux')
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/rolan.jpg");
            break;
        case 'Jérémy Ménez': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/menez.jpg");
            break;
        case 'Jérémy Toulalan': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/jeremy.jpg");
            break;
        case 'Cédric Carrasso': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/cedric.jpg");
            break;
        case 'Jérôme Prior': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/jerome.jpg");
            break;
        case 'Nicolas Pallois': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/nicolas.jpg");
            break;
        case 'Diego Contento': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/diego.jpg");
            break;
        case 'Maxime Poundjé': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/maxime.jpg");
            break;
        case 'Théo Pellenard': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/theo.jpg");
            break;
        case 'Grégory Sertic': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/sertic.jpg");
            break;
        case 'Abdou Traoré': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/abdou.jpg");
            break;
        case 'Jaroslav Plasil': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/plasil.jpg");
            break;
        case 'Younés Kaabouni': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/younes.jpg");
            break;
        case 'Valentín Vada': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/vada.jpg");
            break;
        case 'Nicolas Maurice-Belay': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/nicolas.jpg");
            break;
        case 'Diego Rolán': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/diego.jpg");
            break;
        case 'Thomas Touré': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/toure.jpg");
            break;
        case 'Youssouf Sabaly': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/sabaly.jpg");
            break;
        case 'François Kamano': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/kamano.jpg");
            break;
        case 'Isaac Thelin': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/isaac.jpg");
            break;
        case 'Paul Bernardoni': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/paul.jpg");
            break;
        case 'Pablo': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/pablo.jpg");
            break;
        case 'Milan Gajicu': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/milan.jpg");
            break;
        case 'Gaëtan Laborde': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/laborde.jpg");
            break;
        case 'Mauro Arambarri': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/mauro.jpg");
            break;
        case 'Adam Ounas': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/adam.jpg");
            break;
        case 'Malcom': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/malcom.jpg");
            break;
        case 'Igor Lewczuk': $("#playerPicture").attr("src", "../../Players/LigueOne/Bordeaux/igor.jpg");
            break;
