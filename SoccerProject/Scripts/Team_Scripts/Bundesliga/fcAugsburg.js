$(document).ready(function () {
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/Bundesliga/FC_Augsburg/dirk.jpg");
    $("#managersName").html("<strong>Dirk Schuster</strong>");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/16/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/16/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/halil.jpg");
            break;
        case 'Georg Teigl': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/teigl.jpg");
            break;
        case 'Andreas Luthe': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/luthe.jpg");
            break;
        case 'Alfred Finnbogason': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/alfred.jpg");
            break;
        case 'Marwin Hitz': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/hitz.jpg");
            break;
        case 'Ioannis Gelios': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/gelios.jpg");
            break;
        case 'Jan-Ingwer Callsen-Bracker': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/jan.jpg");
            break;
        case 'Christoph Janker': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/janker.jpg");
            break;
        case 'Tim Rieder': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/tim.jpg");
            break;
        case 'Konstantinos Stafylidis': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/konstantinos.jpg");
            break;
        case 'Philipp Max': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/max.jpg");
            break;
        case 'Daniel Opare': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/daniel.jpg");
            break;
        case 'Paul Verhaegh': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/paul.jpg");
            break;
        case 'Raphael Framberger': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/raphael.jpg");
            break;
        case 'Daniel Baier': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/baier.jpg");
            break;
        case 'Marco Schuster': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/marco.jpg");
            break;
        case 'Dominik Kohr': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/kohr.jpg");
            break;
        case 'Markus Feulner': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/markus.jpg");
            break;
        case 'Jan Moráve': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/janM.jpg");
            break;
        case 'Ja-Cheol Koo': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/koo.jpg");
            break;
        case 'Halil Altintop': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/halil.jpg");
            break;
        case 'Caiuby': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/silva.jpg");
            break;
        case 'Raúl Bobadilla': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/raul.jpg");
            break;
        case 'Dong-Won Ji': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/ji.jpg");
            break;
        case 'Jonathan Schmid': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/jonathan.jpg");
            break;
        case 'Gojko Kacar': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/kacar.jpg");
            break;
        case 'Jeffrey Gouweleeuw': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/jeffrey.jpg");
            break;
        case 'Martin Hinteregger': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/martin.jpg");
            break;
        case 'Takashi Usami': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Augsburg/usami.jpg");
            break;
