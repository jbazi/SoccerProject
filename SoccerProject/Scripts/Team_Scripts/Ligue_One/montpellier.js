$(document).ready(function () {
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LigueOne/Montpellier/hantz.jpg");
    $("#managersName").html("Hantz Frédéric");
...
function renderLoadedPlayers(userSelection) {
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/518/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/518/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function renderTeamLeagueStandingData(result) {
    ...
    $.each(result.standing, function (index) {
        var name = "Montpellier Hérault SC";
    ...
    $('#teamStanding_tbl tr td').each(function () {
        if ($(this).text() === 'Montpellier Hérault SC')
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/ryad.jpg");
            break;
        case 'Anthony Vanden Borre': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/borre.jpg");
            break;
        case 'Geoffrey Jourdren': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/geoffrey.jpg");
            break;
        case 'Laurent Pionnier': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/pionnier.jpg");
            break;
        case 'Jonathan Ligali': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/ligali.jpg");
            break;
        case 'Daniel Congré': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/congre.jpg");
            break;
        case 'Hilton': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/hilton.jpg");
            break;
        case 'Nicolas Saint-Ruf': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/ruf.jpg");
            break;
        case 'Mathieu Deplagne': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/mathieu.jpg");
            break;
        case 'Joris Marveaux': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/joris.jpg");
            break;
        case 'Paul Lasne': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/paul.jpg");
            break;
        case 'Morgan Sanson': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/morgan.jpg");
            break;
        case 'Souleymane Camara': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/camara.jpg");
            break;
        case 'Steve Mounié': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/steve.jpg");
            break;
        case 'Ryad Boudebouz': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/ryad.jpg");
            break;
        case 'William Rémy': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/remy.jpg");
            break;
        case 'Jérôme Roussillon': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/jerome.jpg");
            break;
        case "Mamadou N'Diaye": $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/ndiaye.jpg");
            break;
        case 'Ellyes Skhiri': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/ellyes.jpg");
            break;
        case 'Yacouba Sylla': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/sylla.jpg");
            break;
        case 'Casimir Ninga': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/ninga.jpg");
            break;
        case 'Pierrick Fito': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/fito.jpg");
            break;
        case 'Killian Sanson': $("#playerPicture").attr("src", "../../Players/LigueOne/Montpellier/kilian.jpg");
            break;
