$(document).ready(function () {
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LigueOne/Dijon/oliver.jpg");
    $("#managersName").html("DALL'OGLIO Olivier");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/528/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/528/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/lois.jpg");
            break;
        case 'Mehdi Abeid': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/mehdi.jpg");
            break;
        case 'Dylan Bahamboula': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/dylan.jpg");
            break;
        case 'Florent Balmont': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/florent.jpg");
            break;
        case 'Marvin Martin': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/marvin.jpg");
            break;
        case 'Benjamin Leroy': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/leroy.jpg");
            break;
        case 'Arnold Bouka Moutou': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/arnold.jpg");
            break;
        case 'Baptiste Reynet': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/reynet.jpg");
            break;
        case 'Cédric Varrault': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/cedric.jpg");
            break;
        case 'Quentin Bernard': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/bernard.jpg");
            break;
        case 'Jordan Marié': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/marie.jpg");
            break;
        case '"Anthony Belmont': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/anthony.jpg");
            break;
        case 'Johan Gastien': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/johan.jpg");
            break;
        case 'Pierre Lees Melou': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/pierre.jpg");
            break;
        case 'Frédéric Sammaritano': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/frederic.jpg");
            break;
        case 'Jérémie Bela': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/bela.jpg");
            break;
        case 'Romain Amalfitano': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/romain.jpg");
            break;
        case 'Julio Tavares': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/julio.jpg");
            break;
        case 'Loïs Diony': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/lois.jpg");
            break;
        case 'Yohann Rivière': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/yohann.jpg");
            break;
        case 'Fouad Chafik': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/fouad.jpg");
            break;
        case 'Yunis Abdelhamid': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/yunis.jpg");
            break;
        case 'Jordan Lotiès': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/jordan.jpg");
            break;
        case 'Bobby Allain': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/bobby.jpg");
            break;
        case 'Vincent Rüfli': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/vincent.jpg");
            break;
        case 'Valentin Rosier': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/valentin.jpg");
            break;
        case 'Guillaume Sarrabayrouse': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/sarra.jpg");
            break;
        case 'Ádám Lang': $("#playerPicture").attr("src", "../../Players/LigueOne/Dijon/adam.jpg");
            break;
