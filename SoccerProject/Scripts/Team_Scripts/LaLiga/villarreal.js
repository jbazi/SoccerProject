$(document).ready(function () {
    ...
    $('#teamRssFeed').FeedEk({
        FeedUrl: 'http://www.bbc.com/sport/football/teams/villarreal/rss.xml',
    });
    $("#latestNews").html("Latest Team News");

    $('#teamNews').text('Villareal FC Form');
    $("#myTable").dataTable({
        'iDisplayLength': 5,
        'bJQueryUI': true,
        "aaData": [],
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LaLiga/Villareal/fran.jpg");
    $("#managersName").html("Fran Escribá");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/94/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/94/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/nicola.jpg");
            break;
        case 'Daniele Bonera': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/bonera.jpg");
            break;
        case 'Nicola Sansone': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/nicola.jpg");
            break;
        case 'Roberto Soriano': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/roberto.jpg");
            break;
        case 'Roberto Soldado': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/soldado.jpg");
            break;
        case 'Andrés Fernández': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/andres.jpg");
            break;
        case 'José Ángel': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/jose.jpg");
            break;
        case 'Sergio Asenjo': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/asenjo.jpg");
            break;
        case 'Mateo Musacchio': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/musaccho.jpg");
            break;
        case 'Víctor Ruiz': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/victor.jpg");
            break;
        case 'Jaume Costa': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/costa.jpg");
            break;
        case 'Bojan Jokic': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/jokic.jpg");
            break;
        case 'Mario Gaspar': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/mario.jpg");
            break;
        case 'Antonio Rukavina': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/rukavina.jpg");
            break;
        case 'Bruno Soriano': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/bruno.jpg");
            break;
        case 'Manu Trigueros': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/trigueros.jpg");
            break;
        case 'Jonathan dos Santos': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/santos.jpg");
            break;
        case 'Denis Cheryshev': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/cheryshev.jpg");
            break;
        case 'Mariano Barbosa': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/barbosa.jpg");
            break;
        case "Cédric Bakambu": $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/bakambu.jpg");
            break;
        case 'Rodrigo Hernández': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/rodrigo.jpg");
            break;
        case 'Alexandre Pato': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/pato.jpg");
            break;
        case 'Santos Borré': $("#playerPicture").attr("src", "../../Players/LaLiga/Villareal/borre.jpg");
            break;
