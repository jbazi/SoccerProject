$(document).ready(function () {
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LigueOne/Nancy/pablo.jpg");
    $("#managersName").html("Correa Pablo");
...
function renderLoadedPlayers(userSelection) {
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/520/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/520/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/ait.jpg");
            break;
        case 'Sergey Chernik': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/sergey.jpg");
            break;
        case 'Christophe Mandanne': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/mandanne.jpg");
            break;
        case 'Issiar Dia': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/dia.jpg");
            break;
        case 'Anthony Koura': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/koura.jpg");
            break;
        case 'Guy Ndy Assembé': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/guy.jpg");
            break;
        case 'Clément Lenglet': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/clement.jpg");
            break;
        case 'Modou Diagne': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/modou.jpg");
            break;
        case 'Julien Cetout': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/julien.jpg");
            break;
        case 'Vincent Muratori': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/vincent.jpg");
            break;
        case 'Tobias Badila': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/tobias.jpg");
            break;
        case 'Faitout Maouassa': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/faitout.jpg");
            break;
        case 'Joffrey Cuffaut': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/joffrey.jpg");
            break;
        case 'Diallo Guidileye': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/dialo.jpg");
            break;
        case 'Benoît Pedretti': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/benoit.jpg");
            break;
        case 'Youssef Aït Bennasser': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/ait.jpg");
            break;
        case 'Loïc Puyo': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/puyo.jpg");
            break;
        case 'Anthony Robic': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/robic.jpg");
            break;
        case 'Maurice Dalé': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/dale.jpg");
            break;
        case 'Youssouf Hadji': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/hadji.jpg");
            break;
        case 'Karim Coulibaly': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/karim.jpg");
            break;
        case 'Alexandre Menay': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/menay.jpg");
            break;
        case 'Vincent Marchetti': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/marchetti.jpg");
            break;
        case "Serge N'Guessan": $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/serge.jpg");
            break;
        case 'Yann Mabella': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/mabella.jpg");
            break;
        case 'Erick Cabaco': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/erick.jpg");
            break;
        case 'Alou Diarra': $("#playerPicture").attr("src", "../../Players/LigueOne/Nancy/sarr.jpg");
            break;
