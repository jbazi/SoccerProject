$(document).ready(function () {
    ...
    $('#teamRssFeed').FeedEk({
        FeedUrl: 'http://www.bbc.com/sport/football/teams/granada/rss.xml',
    });
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LaLiga/Granada/alcaraz.jpg");
    $("#managersName").html("Lucas Alcaraz");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/83/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/83/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/andreas.jpg");
            break;
        case 'Ivan Kelava': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/kelava.jpg");
            break;
        case 'Gabriel Silva': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/gabriel.jpg");
            break;
        case 'Gastón Silva': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/gaston.jpg");
            break;
        case 'Rene Krhin': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/krhin.jpg");
            break;
        case 'Guillermo Ochoa': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/ochoa.jpg");
            break;
        case 'David Barral': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/barral.jpg");
            break;
        case 'Oier Olazábal': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/oier.jpg");
            break;
        case 'Dimitri Foulquier': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/dimitri.jpg");
            break;
        case 'Luís Martins': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/martins.jpg");
            break;
        case 'Javi Márquez': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/javi.jpg");
            break;
        case 'Isaac Cuenca': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/isaac.jpg");
            break;
        case 'Sergi Samper': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/samper.jpg");
            break;
        case 'David Lombán': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/lomban.jpg");
            break;
        case 'Tito': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/tito.jpg");
            break;
        case 'Matthieu Saunier': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/matthieu.jpg");
            break;
        case 'Jeremie Boga': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/boga.jpg");
            break;
        case 'Ezequiel Ponce': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/ezequiel.jpg");
            break;
        case 'Andreas Pereira': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/andreas.jpg");
            break;
        case 'Victorien Angban': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/victorien.jpg");
            break;
        case 'Uche Agbo': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/uche.jpg");
            break;
        case 'Jon Toral': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/jon.jpg");
            break;
        case 'José Angulo': $("#playerPicture").attr("src", "../../Players/LaLiga/Granada/jose.jpg");
            break;
