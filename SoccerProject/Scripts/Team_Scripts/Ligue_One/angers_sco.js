$(document).ready(function () {
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LigueOne/Angers_Sco/moulin.jpg");
    $("#managersName").html("MOULIN Stéphane");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/532/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/532/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/mangani.jpg");
            break;
        case 'Grégory Bourillon': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/bourillon.jpg");
            break;
        case 'Jamel Saihi': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/saihi.jpg");
            break;
        case 'Gilles Sunu': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/sunu.jpg");
            break;
        case 'Mateo Pavlovic': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/pavlovic.jpg");
            break;
        case 'Denis Petric': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/petric.jpg");
            break;
        case 'Pablo Martinez': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/martinez.jpg");
            break;
        case 'Alexandre Letellier': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/letellier.jpg");
            break;
        case 'Romain Thomas': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/thomas.jpg");
            break;
        case 'Ismaël Traoré': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/traore.jpg");
            break;
        case 'Yoann Andreu': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/andreu.jpg");
            break;
        case 'Ibrahima Diallo': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/diallo.jpg");
            break;
        case 'Vincent Manceau': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/manceau.jpg");
            break;
        case 'Cheikh Ndoye': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/ndoye.jpg");
            break;
        case 'Mathias Serin': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/serin.jpg");
            break;
        case 'Pierrick Capelle': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/capelle.jpg");
            break;
        case 'Billy Ketkeophomphone': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/billy.jpg");
            break;
        case 'Férébory Doré': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/dore.jpg");
            break;
        case 'Mathieu Michel': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/michel.jpg");
            break;
        case 'Karl Toko Ekambi': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/toko.jpg");
            break;
        case 'Baptiste Santamaría': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/santamaria.jpg");
            break;
        case 'Mehdi Jean Tahrat': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/mehdi.jpg");
            break;
        case 'Famara Diédhiou': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/famara.jpg");
            break;
        case 'Flavien Tait': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/tait.jpg");
            break;
        case 'Dickson Nwakaeme': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/nwakaeme.jpg");
            break;
        case 'Yoane Wissa': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/wissa.jpg");
            break;
        case 'Nicolas Pepe': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/pepe.jpg");
            break;
        case 'Thomas Mangan': $("#playerPicture").attr("src", "../../Players/LigueOne/Angers_Sco/mangani.jpg");
            break;
