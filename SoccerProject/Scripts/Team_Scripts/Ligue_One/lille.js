$(document).ready(function () {
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LigueOne/Lille/collot.jpg");
    $("#managersName").html("Patrick COLLOT");
...
function renderLoadedPlayers(userSelection) {
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/521/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/521/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/eder.jpg");
            break;
        case 'Mounir Obbadi': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/mounir.jpg");
            break;
        case 'Morgan Amalfitano': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/morgan.jpg");
            break;
        case 'Nicolas de Préville': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/nicolas.jpg");
            break;
        case 'Mike Maignan': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/mike.jpg");
            break;
        case 'Eric Bauthéac': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/eric.jpg");
            break;
        case 'Vincent Enyeama': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/enyeama.jpg");
            break;
        case 'Jean Butez': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/butez.jpg");
            break;
        case 'Marko Basa': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/basa.jpg");
            break;
        case 'Adama Soumaoro': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/adama.jpg");
            break;
        case 'Sébastien Corchia': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/corchia.jpg");
            break;
        case 'Franck Béria': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/beria.jpg");
            break;
        case 'Rio Mavuba': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/rio.jpg");
            break;
        case 'Ryan Mendes': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/ryan.jpg");
            break;
        case 'Younousse Sankharé': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/sankhare.jpg");
            break;
        case 'Julian Palmieri': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/julian.jpg");
            break;
        case 'Yassine Benzia': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/benzia.jpg");
            break;
        case 'Éder': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/eder.jpg");
            break;
        case 'Renato Civelli': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/civelli.jpg");
            break;
        case 'Stoppila Sunzu': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/sunzu.jpg");
            break;
        case 'Youssouf Koné': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/kone.jpg");
            break;
        case 'Ibrahim Amadou': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/ibrahim.jpg");
            break;
        case 'Junior Tallo': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/junior.jpg");
            break;
        case 'Rony Lopes': $("#playerPicture").attr("src", "../../Players/LigueOne/Lille/rony.jpg");
            break;
