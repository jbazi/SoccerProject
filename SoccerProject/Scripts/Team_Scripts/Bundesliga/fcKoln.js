$(document).ready(function () {
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/Bundesliga/FC_Koln/peter.jpg");
    $("#managersName").html("<strong>Peter Stöger</strong>");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/1/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/1/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/anthony.jpg");
            break;
        case 'Filip Mladenovic': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/filip.jpg");
            break;
        case 'Artjoms Rudnevs': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/rudnevs.jpg");
            break;
        case 'Konstantin Rausch': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/rausch.jpg");
            break;
        case 'Marco Höger': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/marco.jpg");
            break;
        case 'Timo Horn': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/timoHorn.jpg");
            break;
        case 'Thomas Kessler': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/kessler.jpg");
            break;
        case 'Dominique Heintz': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/heintz.jpg");
            break;
        case 'Frederik Sörensen': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/frederik.jpg");
            break;
        case 'Dominic Maroh': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/maroh.jpg");
            break;
        case 'Mergim Mavraj': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/mavraj.jpg");
            break;
        case 'Jonas Hector': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/hector.jpg");
            break;
        case 'Pawel Olkowski': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/pawel.jpg");
            break;
        case 'Lukas Klünter': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/lukas.jpg");
            break;
        case 'Matthias Lehmann': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/lehmann.jpg");
            break;
        case 'Milos Jojic': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/jojic.jpg");
            break;
        case 'Leonardo Bittencourt': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/jesus.jpg");
            break;
        case 'Marcel Risse': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/risse.jpg");
            break;
        case 'Anthony Modeste': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/anthony.jpg");
            break;
        case 'Yuya Osako': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/yuya.jpg");
            break;
        case 'Simon Zoller': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/simon.jpg");
            break;
        case 'Sehrou Guirassy': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/sehrou.jpg");
            break;
        case 'Sven Müller': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/svenMuller.jpg");
            break;
        case 'Marcel Hartel': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/hartel.jpg");
            break;
        case 'Salih Özcan': $("#playerPicture").attr("src", "../../Players/Bundesliga/FC_Koln/salih.jpg");
            break;
