$(document).ready(function () {
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/Bundesliga/Freiburg/streich.jpg");
    $("#managersName").html("<strong>	Christian Streich</strong>");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/17/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/17/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/philipp.jpg");
            break;
        case 'Marc Torrejón': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/marc.jpg");
            break;
        case 'Marc-Oliver Kempf': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/oliver.jpg");
            break;
        case 'Christian Günter': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/christian.jpg");
            break;
        case 'Julian Schuster': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/julian.jpg");
            break;
        case 'Nicolas Höfler': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/nicolas.jpg");
            break;
        case 'Mike Frantz': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/mike.jpg");
            break;
        case 'Mats Möller Daehli': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/mats.jpg");
            break;
        case 'Maximilian Philipp': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/philipp.jpg");
            break;
        case 'Nils Petersen': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/nils.jpg");
            break;
        case 'Karim Guédé': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/karim.jpg");
            break;
        case 'Janik Haberer': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/janik.jpg");
            break;
        case 'Rafal Gikiewicz': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/rafal.jpg");
            break;
        case 'Havard Nielsen': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/havard.jpg");
            break;
        case 'Onur Bulut': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/onur.jpg");
            break;
        case 'Patric Klandt': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/patric.jpg");
            break;
        case 'Vincenzo Grifo': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/grifo.jpg");
            break;
        case 'Lukas Kübler': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/lukas.jpg");
            break;
        case 'Manuel Gulde': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/manuel.jpg");
            break;
        case 'Jonas Meffert': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/jonas.jpg");
            break;
        case 'Aleksandar Ignjovski': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/aleksander.jpg");
            break;
        case 'Georg Niedermeier': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/georg.jpg");
            break;
        case 'Florian Niederlechner': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/florian.jpg");
            break;
        case 'Pascal Stenzel': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/pascal.jpg");
            break;
        case 'Alexander Schwolow': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/alexander.jpg");
            break;
        case 'Jonas Föhrenbach': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/jonas.jpg");
            break;
        case 'Amir Abrashi': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/amir.jpg");
            break;
        case 'Lucas Hufnagel': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/lucas.jpg");
            break;
        case 'Amir Falahen': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/amir.jpg");
            break;
        case 'Caglar Söyüncü': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/caglar.jpg");
            break;
        case 'Charles Elie Laprevotte': $("#playerPicture").attr("src", "../../Players/Bundesliga/Freiburg/charles.jpg");
            break;
