$(document).ready(function () {
    ...
    $('#teamRssFeed').FeedEk({
        FeedUrl: 'http://www.bbc.com/sport/football/teams/las-palmas/rss.xml',
    });
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LaLiga/LasPalmas/setien.jpg");
    $("#managersName").html("Quique Setién");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/275/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/275/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/marko.jpg");
            break;
        case 'Míchel': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/michel.jpg");
            break;
        case 'Nabil El Zhar': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/elZhar.jpg");
            break;
        case 'Hélder Lopes': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/helder.jpg");
            break;
        case 'Javi Varas': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/javi.jpg");
            break;
        case 'Raúl Lizoain': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/raul.jpg");
            break;
        case 'Aythami Artiles': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/aythami.jpg");
            break;
        case 'Pedro Bigas': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/bigas.jpg");
            break;
        case 'David García': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/davidGarcia.jpg");
            break;
        case 'David Simón': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/david.jpg");
            break;
        case 'Javi Castellano': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/javiCastellano.jpg");
            break;
        case 'Vicente Gómez': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/vicente.jpg");
            break;
        case 'Hernán': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/hernan.jpg");
            break;
        case 'Roque Mesa': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/roque.jpg");
            break;
        case 'Dani Castellano': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/dani.jpg");
            break;
        case 'Jonathan Viera': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/viera.jpg");
            break;
        case 'Momo': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/momo.jpg");
            break;
        case 'Tana': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/tana.jpg");
            break;
        case 'Sergio Araujo': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/araujo.jpg");
            break;
        case 'Marko Livaja': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/livaja.jpg");
            break;
        case 'Mauricio Lemos': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/lemos.jpg");
            break;
        case 'Ángel Montoro': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/montoro.jpg");
            break;
        case 'Mateo García': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/mateo.jpg");
            break;
        case 'Tyronne': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/tyronne.jpg");
            break;
        case 'José Artiles': $("#playerPicture").attr("src", "../../Players/LaLiga/LasPalmas/jose.jpg");
            break;
