$(document).ready(function () {
    ...
    $('#teamRssFeed').FeedEk({
        FeedUrl: 'http://www.bbc.com/sport/football/teams/valencia/rss.xml',
    });
    $("#latestNews").html("Latest Team News");

    $('#teamNews').text('Valencia FC Form');
    ...
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/LaLiga/Valencia/prandelli.jpg");
    $("#managersName").html("Cesare Prandelli");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/95/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/95/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/nani.jpg");
            break;
        case 'Aymen Abdennour': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/abdennour.jpg");
            break;
        case 'Nani': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/nani.jpg");
            break;
        case 'Santi Mina': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/santi.jpg");
            break;
        case 'Martín Montoya': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/montoya.jpg");
            break;
        case 'Diego Alves': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/diego.jpg");
            break;
        case 'Rúben Vezo': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/ruben.jpg");
            break;
        case 'José Luis Gayá': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/gaya.jpg");
            break;
        case 'João Cancelo': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/cancelo.jpg");
            break;
        case 'Enzo Pérez': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/enzo.jpg");
            break;
        case 'Dani Parejo': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/parejo.jpg");
            break;
        case 'Rodrigo': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/rodrigo.jpg");
            break;
        case 'Paco Alcácer': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/paco.jpg");
            break;
        case 'Federico Cartabia': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/fede.jpg");
            break;
        case 'Guilherme Siqueira': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/siqueira.jpg");
            break;
        case 'Robert Ibáñez': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/robert.jpg");
            break;
        case 'Aderlan Santos': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/aderllan.jpg");
            break;
        case 'Álvaro Medrán': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/alvaro.jpg");
            break;
        case 'Mathew Ryan': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/mathew.jpg");
            break;
        case 'Zakaria Bakkali': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/bakkali.jpg");
            break;
        case 'Salva Ruiz': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/ruiz.jpg");
            break;
        case 'Jaume Doménech': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/jaume.jpg");
            break;
        case 'Mario Suárez': $("#playerPicture").attr("src", "../../Players/LaLiga/Valencia/mario.jpg");
            break;
