$(document).ready(function () {
    ...
    $('#teamRssFeed').FeedEk({
        FeedUrl: 'http://www.bbc.com/sport/football/teams/everton/rss.xml',
    });
    ...
    var userSelection = "Romelu Lukaku";
    renderLoadedPlayers(userSelection);
    $('#playerInfo_tbl').hide();
    $("#managedBy").attr("src", "../../Players/PremierLeague/Everton/ronaldKoeman.jpg");
    $("#managersName").html("ronald Koeman");
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/62/players',
        dataType: 'json',
...
function playerLoad(playerName) {
    var select = document.getElementById("selectPlayer");
    switch (playerName) {
        case 'Choose A Player': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Lukaku.jpg");
            break;
        case 'Idrissa Gueye': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Gueye.jpg");
            break;
        case 'Conor McAleny': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/ConorMcAleny.jpg");
            break;
        case 'Joel Robles': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Robles.jpg");
            break;
        case 'Maarten Stekelenburg': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Stekelenburg.jpg");
            break;
        case 'Ramiro Funes Mori': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/FunesMori.jpg");
            break;
        case 'Ashley Williams': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Williams.jpg");
            break;
        case 'Phil Jagielka': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Jagielka.jpg");
            break;
        case 'Leighton Baines': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Baines.jpg");
            break;
        case 'Bryan Oviedo': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Oviedo.jpg");
            break;
        case 'Seamus Coleman': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Coleman.jpg");
            break;
        case 'Tyias Browning': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Browning.jpg");
            break;
        case 'Muhamed Besic': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Besic.jpg");
            break;
        case 'Gareth Barry': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Barry.jpg");
            break;
        case 'James McCarthy': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/McCarthy.jpg");
            break;
        case 'Tom Cleverley': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Cleverley.jpg");
            break;
        case 'Darron Gibson': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Gibson.jpg");
            break;
        case 'Ross Barkley': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Barkley.jpg");
            break;
        case 'Kevin Mirallas': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Mirallas.jpg");
            break;
        case 'Gerard Deulofeu': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Deulofeu.jpg");
            break;
        case 'Aaron Lennon': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/ozil.jpg");
            break;
        case 'Alex Iwobi': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Lennon.jpg");
            break;
        case 'Romelu Lukaku': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Lukaku.jpg");
            break;
        case 'Oumar Niasse': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Niasse.jpg");
            break;
        case 'Arouna Koné': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Kone.jpg");
            break;
        case 'Leandro Rodríguez': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Rodriguez.jpg");
            break;
        case 'Enner Valencia': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Enner.jpg");
            break;
        case 'Yannick Bolasie': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Bolasie.jpg");
            break;
        case 'Mason Holgate': $("#playerPicture").attr("src", "../../Players/PremierLeague/Everton/Holgate.jpg");
            break;
