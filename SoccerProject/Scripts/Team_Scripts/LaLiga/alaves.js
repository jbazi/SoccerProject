$(document).ready(function () {
    ...
    $('#teamRssFeed').FeedEk({
        FeedUrl: 'http://www.bbc.com/sport/football/teams/deportivo-alaves/rss.xml',
    });
...
function renderLoadedPlayers(userSelection) {
 ...
 "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"
    ...
    $.ajax({
        ...
        url: 'http://api.football-data.org/v1/teams/263/players',
        dataType: 'json',
...
function getTeamFixtures() {
    $.ajax({
        headers: { 'X-Auth-Token': 'e4a0c71e6e9f4981b9706379992f468a' },
        url: 'http://api.football-data.org/v1/teams/263/fixtures',
        dataType: 'json',
        type: 'GET',
    }).done(function (response) {
...
function playerLoad(playerName) {
    ...
    switch (playerName) {
        ...
        case 'Kiko Casilla': $("#playerPicture").attr("src", "../../Players/LaLiga/RealMadrid/casilla.jpg");
            break;
        case 'Lucas Vázquez': $("#playerPicture").attr("src", "../../Players/LaLiga/RealMadrid/cech.jpg");
            break;
